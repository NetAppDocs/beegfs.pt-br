...
NOTE: Se você estiver atualizando para BeeGFS 8, consulte o link:clusters-upgrade-beegfs-v8.html["Atualize para BeeGFS 8"] procedimento em vez disso.
...
| 7.4.6 | 8,0 | Sim | Atualize usando as instruções no link:clusters-upgrade-beegfs-v8.html["Atualize para BeeGFS 8"] procedimento. 


| 7.4.6 | 8,1 | Sim | Atualize usando as instruções no link:clusters-upgrade-beegfs-v8.html["Atualize para BeeGFS 8"] procedimento. 


| 7.4.6 | 8,2 | Sim | Atualize usando as instruções no link:clusters-upgrade-beegfs-v8.html["Atualize para BeeGFS 8"] procedimento. 
|===
