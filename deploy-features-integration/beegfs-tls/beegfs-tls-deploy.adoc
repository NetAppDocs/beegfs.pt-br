...
. Copie remotamente com segurança o certificado do cliente para o cliente e renomeie o certificado para  `cert.pem` no cliente:
+
[source, console]
----
...
----
. Verifique a conectividade do cliente executando um  `beegfs CLI` comando, como:
+
[source, console]
----
beegfs health check
